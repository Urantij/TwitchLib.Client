...
namespace TwitchLib.Client
{
    ...
    /// Implements the <see cref="TwitchLib.Client.Interfaces.IAsyncTwitchClient" />
    /// </summary>
    /// <seealso cref="TwitchLib.Client.Interfaces.IAsyncTwitchClient" />
    public class AsyncTwitchClient : IAsyncTwitchClient
    {
        ...
        public AsyncTwitchClient(IAsyncClient client = null, ClientProtocol protocol = ClientProtocol.WebSocket, ILogger<TwitchClient> logger = null)
        {
            _logger = logger;
            _client = client;
            _protocol = protocol;
            ...
            if (_client == null)
            {
                switch (_protocol)
                {
                    ...
                    case ClientProtocol.WebSocket:
                        _client = new AsyncWebSocketClient();
                        break;
                }
            }
